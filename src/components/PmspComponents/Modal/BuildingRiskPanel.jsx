...
export default function BuildingRiskPanel({ onClose, onZoomTo }) {
  ...
  return (
     <div className="max-h-[calc(100vh-120px)] h-fit w-[450px] bg-white shadow-2xl rounded-xl border border-gray-200 overflow-hidden flex flex-col animate-in fade-in slide-in-from-left-2 duration-300">
      <div className="shrink-0">
        <div className="bg-[#37474F] p-2 px-4 flex items-center justify-between text-white">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar bg-white">
        <table className="w-full text-[10px] border-collapse">
          {activeTab === 'obj' ? (
            <>
              <thead className="bg-white sticky top-0 border-b border-gray-200 text-gray-400">
                <tr>
